...
function NewAssessMent() {
    ...
    const handleSubmitClick = () => {
        const { name, purpose, date, duration, questions, link } =
            assessmentData;
    ...
    return (
        <>
            ...
            >
                <label className={styles.formLabel} htmlFor="assessment-name">
                    Name of Assesment
                </label>
                <input
                ...
                <label className={styles.formLabel} htmlFor="assessment-date">
                    Date
                </label>
                <input
                    className={`${styles.formItem} ${styles.date}`}
                    type="date"
                ...
                <label
                    className={styles.formLabel}
                    htmlFor="assessment-questions"
                >
                    Questions of Assesment
                </label>
                <input
                    className={styles.formItem}
                    type="number"
                    value={assessmentData.questions}
                    data-val="questions"
                    onChange={handleInputChange}
                    placeholder="Type Name"
                ...
                <label className={styles.formLabel} htmlFor="assessment-link">
                    Link of the Assesment
                </label>
                <input
                    className={styles.formItem}
                    type="text"
